...
class GCSService(private val userRepository: UserRepository,
                 ...
                 @Value("\${firebase-key}") private val firebaseKey: String,
                 @Value("\${cdn-signing-key}") private val cdnSigningKey: String) {
    ...
    fun finalSignedPrefixUrl(): String {
        ...
        val keyBytes = Base64.getUrlDecoder().decode(String(cdnSigningKey.toByteArray(), StandardCharsets.UTF_8))
    ...
    fun signedUrlHelper(objectName: String): Pair<Storage, BlobInfo> {
        ...
        val firebaseKeyByteArray = ByteArrayInputStream(firebaseKey.toByteArray())
        val storage = StorageOptions.newBuilder()
                .setCredentials(GoogleCredentials.fromStream(firebaseKeyByteArray))
    ...
    fun signedGetURL(objectPath: String): String? {
        ...
        val urlToSign = (requestUrl
                ...
                + "&KeyName=" + keyName)
        val base64String = String(cdnSigningKey.toByteArray(), StandardCharsets.UTF_8)
